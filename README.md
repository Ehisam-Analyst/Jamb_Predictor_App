...
This project uses AI to predict a student's JAMB score using past academic performance and provides personalized recommendations to improve their score.
...
```bash
git clone https://github.com/Ehisam-Analyst/Jamb_Predictor_App.git
